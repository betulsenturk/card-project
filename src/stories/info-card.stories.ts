...
const Template: StoryFn = (args) => html`
  <info-card .background="${args.background}" .cardTitle="${args.cardTitle}" .date="${args.date}" .imgUrl="${args.imgUrl}" .content="${args.content}" .text="${args.text}">
  </info-card>
`;
